...
export default function ProductsPageClient({ initialProducts, collections }: ProductsPageClientProps) {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const filteredProducts = await client.fetch(filteredProductsQuery, params);
          ...
          <div className="flex gap-8">
            ...
            <div className="hidden lg:block w-64 shrink-0">
              <div className="sticky top-6">
                <ProductFiltersSidebar onFilterChange={handleFilterChange} collections={collections} initialFilters={filters} />
              </div>
            </div>
