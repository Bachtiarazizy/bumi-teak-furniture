        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-secondary/5 border-l-4 border-secondary p-6 rounded-r-lg">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <h5 className="font-heading text-lg text-secondary mb-2">Production & Lead Times</h5>
              ...
              <div>
                <h4 className="font-heading text-xl text-secondary mb-4">Customs & Import Duties</h4>
              ...
              <div>
                <h4 className="font-heading text-xl text-secondary mb-4">Tracking & Updates</h4>
                <p className="font-body text-sm text-secondary leading-relaxed mb-3">
              ...
              <div>
                <h4 className="font-heading text-xl text-secondary mb-4">Delivery & Inspection</h4>
                <p className="font-body text-sm text-secondary leading-relaxed mb-3">
              ...
              <div>
                <h4 className="font-heading text-xl text-secondary mb-4">Large Items & Curbside Delivery</h4>
                <p className="font-body text-sm text-secondary leading-relaxed">
            ...
            <div className="mt-12 p-8 bg-light rounded-lg text-center">
              <h4 className="font-heading text-2xl text-secondary mb-3">Need a Custom Shipping Quote?</h4>
